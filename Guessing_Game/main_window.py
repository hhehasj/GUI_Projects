...
class Main(ctk.CTk):
    def __init__(self):
        ...
        self.greeting_lbl = ctk.CTkLabel(self, text="GUESSING GAME!!!",
                                         bg_color="green",
                                         font=("Helvetica", 75, "bold"),
                                         text_color="white",
                                         corner_radius=20)
        self.greeting_lbl.place(relx=0.5, rely=0.3, anchor="center",
                                relwidth=0.9, relheight=0.15)

        self.start_btn = ctk.CTkButton(self, text="GAME ON!!!",
                                       font=("Calibri", 25),
                                       fg_color="#ebebeb",
                                       text_color="red",
                                       hover_color="red",
        ...
        self.leaderboard_btn = ctk.CTkButton(self, text="Leaderboard",
                                             font=("Calibri", 25),
                                             fg_color="#ebebeb",
                                             text_color="green",
                                             hover_color="#008000",
                                             border_color="green",
                                             border_width=3)
        self.leaderboard_btn.place(relx=0.7, rely=0.5, anchor="center",
                                   relwidth=0.17, relheight=0.1)
...
class Username_window(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        self.text_msg = ctk.CTkLabel(self, text="Enter your username:",
                                     font=("Arial", 25))
        self.text_msg.place(relx=0.5, rely=0.2, anchor="center")

        Username_variable = ctk.StringVar()
        self.username_input = ctk.CTkEntry(self, textvariable=Username_variable,
                                           font=("Arial", 15),
                                           border_width=3,
                                           border_color="black")
        self.username_input.place(relx=0.5, rely=0.45, anchor="center",
                                  relwidth=0.8, relheight=0.18)

        self.enter_btn = ctk.CTkButton(self, text="Enter",
                                       font=("Calibri", 28, "bold"),
                                       border_width=3,
                                       border_color="black",
                                       border_spacing=2,
                                       corner_radius=7,
                                       # command=self.switch_to_game
                                       )
